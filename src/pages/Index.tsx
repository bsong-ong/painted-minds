          ...
          <div className="lg:col-span-3 w-full min-w-0 space-y-4">
            ...
            <Card className="h-fit w-full bg-gradient-to-r from-primary/10 to-gratitude-warm/10 border-primary/20">
              <CardHeader className="px-3 sm:px-6">
                <CardTitle className="text-lg sm:text-xl text-center bg-gradient-to-r from-primary to-gratitude-warm bg-clip-text text-transparent">Start Your Daily Gratitude Practice</CardTitle>
              </CardHeader>
            ...
            <Card className="h-fit w-full bg-card/50 backdrop-blur-sm border-border/50">
              <CardHeader className="px-3 sm:px-6">
                <CardTitle className="text-lg sm:text-xl bg-gradient-to-r from-primary to-gratitude-success bg-clip-text text-transparent">Your Recent Gratitude Art</CardTitle>
              </CardHeader>
